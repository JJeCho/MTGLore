...
const ManaValuePage = ({ params }: { params: { value: string } }) => {
  ...
  const { value } = params; // Convert the route parameter to a float
  ...
  }, [value, skip]); // Ensure "value" is used in the dependency array
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gradient-to-b from-gray-100 to-gray-300 p-4 sm:p-6 lg:p-8">
      <h1 className="text-3xl font-bold mb-4">Mana Value: {value}</h1>
